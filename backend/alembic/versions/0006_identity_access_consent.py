...
def upgrade():
 ...
 op.execute(sa.text("INSERT INTO consent_templates (id, organization_id, name, version, body, is_active, requires_renewal) VALUES (CAST(:id AS uuid), NULL, :name, 1, :body, true, true)").bindparams(id=cid,name="ALI Simulations Participation Consent",body=consent))
def downgrade():
